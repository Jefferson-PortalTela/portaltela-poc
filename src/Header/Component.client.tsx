...
export const HeaderClient: React.FC<HeaderClientProps> = ({ data }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-x-0 top-0 z-50 transform-gpu transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${showCompactHeader ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0 pointer-events-none'}`}
        {...(headerThemeAttribute ? { 'data-theme': headerThemeAttribute } : {})}
      >
